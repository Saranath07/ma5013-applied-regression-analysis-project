...
\author{
    Saranath P (DA25E003) \and S Shriprasad (DA25E054) \\
    \small Indian Institute of Technology Madras \\
    \small MA 5013: Applied Regression Analysis, Fall 2025
}
...
\begin{table}[h!]
    \centering
    \caption{VIF Scores for the Naive OLS Model.}
    \label{tab:vif_ols}
    \begin{tabular}{lr}
        \toprule
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{plot_ols_qq.png}
    \caption{Q-Q plot of residuals from the naive OLS model, showing a severe violation of the normality assumption.}
    \label{fig:ols_qq}
\end{figure}
